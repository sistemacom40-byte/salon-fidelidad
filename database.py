...
def crear_tablas():
    ...
    if USANDO_POSTGRES:
        ...
        cur.execute("ALTER TABLE promo ADD COLUMN IF NOT EXISTS mensaje_largo TEXT")
        ...
        if not _columna_existe_sqlite(cur, "promo", "mensaje_largo"):
            cur.execute("ALTER TABLE promo ADD COLUMN mensaje_largo TEXT")
